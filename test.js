...
test('ilkin doldurma bootstrap: create/update/station/qty', function () {
  ...
  assert.ok(html.indexOf('bootstrap.css?v=3') >= 0);
  assert.ok(html.indexOf('bootstrap-ui.js?v=2') >= 0);
  ...
  assert.ok(bootUi.indexOf('sətir tətbiq olundu') >= 0);
  assert.ok(bootUi.indexOf('resetGrid()') >= 0);
  assert.ok(bootUi.indexOf('clearAfter.checked') >= 0);
